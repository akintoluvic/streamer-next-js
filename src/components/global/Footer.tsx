      ...
      <Wrapper className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
        ...
        <div>
          ...
          <Text tag="p" variant="textXS" className="text-neutral-500 mt-1">
            Your privacy is important to us. We avoid invasive practices such as
            data tracking, fingerprinting, or sharing your information with
            third parties. Instead, we use
            <a href="#_" className="dark:text-neutral-500 text-black underline">
              Umami
            </a>
        ...
        <div>
          ...
          <Text tag="p" variant="textXS" className="text-neutral-500 mt-1">
            This site uses Instrument Serif and Inter font. The frontend code is
        ...
        <div>
          ...
          <Text tag="p" variant="textXS" className="text-neutral-500 mt-1">
            The web is a big, big place with lots of people, places, and things
            to see. Thanks for visiting our little corner of the internet.
          </Text>
        </div>
        <Text
          tag="p"
